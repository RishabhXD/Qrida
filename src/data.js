export const Data = [
  ...
  [
    ...
    },
    {
      id: 2,
      message2:
        "I’d a session with an organization working with migrants in the country. Do you want to organize it in your area?",
    },
    {
      id: 3,
      message3:
  ...
  [
    ...
    },
    {
      id: 2,
      message2:
        "It has been an unusually wet season this year. Remember to make sure to have arrangements ready in the course of your work in case the worst happens",
    },
    {
      id: 3,
      message3:
  ...
  [
    ...
    },
    {
      id: 2,
      message2:
        "It's heartening to see citizens preserving monuments and using them for healthy community events. The culture is ours to preserve and proudly uphold. Keep up the good work!",
    },
    {
      id: 3,
      message3:
        "Hello Sir/Ma'am, I've come to understand some provisions of the state subsidy scheme for backward castes. Can you please help me?",
    },
  ],
  [
    {
    ...
    },
    {
      id: 3,
      message3:
        "Hi Name, Let's talk about the issue of the state's highways and inefficient road transport connectivity. We're not happy with what has been accomplished so far. Can you shed some light?",
    },
  ],
  [
    {
